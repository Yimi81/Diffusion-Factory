...
class CustomLoraTrainer:
    ...
    def train(self):
        ...
        unet_lora_config = LoraConfig(
            r=finetuning_args.lora_rank, lora_alpha=finetuning_args.lora_alpha, lora_dropout=finetuning_args.lora_dropout, init_lora_weights="gaussian", target_modules=["to_k", "to_q", "to_v", "to_out.0"]
        )
